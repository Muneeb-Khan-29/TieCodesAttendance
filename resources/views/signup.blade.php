...
<head>
    ...
    <style>
        ...
        body {
            ...
            background: -webkit-linear-gradient(to top, #fff404, #fcaf17);
            background: -moz-linear-gradient(to top, #fff404, #fcaf17);
            background: -o-linear-gradient(to top, #fff404, #fcaf17);
            background: linear-gradient(to top, #fff404, #fcaf17);
